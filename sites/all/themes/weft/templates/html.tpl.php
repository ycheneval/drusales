...
<!--[if (gte IE 9)]> <html lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"<?php print $rdf_namespaces; ?> class="no-js ie9"> <![endif]-->
...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <!--[if (gte IE 6)&(lte IE 8)]>
    <script type="text/javascript" src="<?php print $base_url . path_to_theme() ?>/js/selectivizr-min.js"></script>
  <![endif]-->
</head>
