...
arrowimage: {classname: 'downarrowclass', src: '/sites/all/themes/weft/images/down.gif', leftpadding: 0}, //customize down arrow image
animateduration: {over: 200, out: 100}, //duration of slide in/ out animation, in milliseconds

buildmenu:function(menuid){
	jQuery(document).ready(function($){
		var $mainmenu=$("#"+menuid+"> div.content >div > ul")
...
droplinemenu.buildmenu("block-menu-block-3")
